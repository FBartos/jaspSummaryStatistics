...
Form 
{
	Group
	{
		...
		DoubleField  { name: "mean";		label: qsTr("Mean"); visible: inputType.value === "meanAndSD"				}
		DoubleField  { name: "sd";			label: qsTr("Standard Deviation"); visible: inputType.value === "meanAndSD" }
